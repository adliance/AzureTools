...
namespace Adliance.AzureTools.CopyDatabase.Parameters
{
    ...
    {
        [Option("source", Required = true, Default = "", HelpText = "The connection string to the source database.")] public string Source { get; set; } = "";
        [Option("target", Required = true, Default = "", HelpText = "The connection string to the target database.")] public string Target { get; set; } = "";
